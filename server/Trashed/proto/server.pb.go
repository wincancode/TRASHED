...
var file_server_proto_goTypes = []any{
	(*GameCode)(nil),      // 0: server.GameCode
	(*PlayerData)(nil),    // 1: server.PlayerData
	(*GameData)(nil),      // 2: server.GameData
	(*GameState)(nil),     // 3: server.GameState
	(*PlayerState)(nil),   // 4: server.PlayerState
	(*PlayerShot)(nil),    // 5: server.PlayerShot
	(*AsteroidState)(nil), // 6: server.AsteroidState
	(*BulletState)(nil),   // 7: server.BulletState
	(*Empty)(nil),         // 8: server.Empty
}
var file_server_proto_depIdxs = []int32{
	1, // 0: server.GameData.players:type_name -> server.PlayerData
	4, // 1: server.GameState.players:type_name -> server.PlayerState
	6, // 2: server.GameState.asteroids:type_name -> server.AsteroidState
	7, // 3: server.GameState.bullets:type_name -> server.BulletState
